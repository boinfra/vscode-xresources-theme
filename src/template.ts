...
export default (colors: Color[], bordered: boolean) => ({
	...
	colors: {
		...
		'sideBarTitle.foreground': colors[7].hex(),
		'sideBarSectionHeader.background': colors[0].hex(),
		'sideBarSectionHeader.foreground': colors[7].hex(),
		...
		'tab.activeBackground': bordered ? colors[0].lighten(0.2).hex() : colors[0].hex(),
		...
		// EDITOR
		'editor.background': bordered ? colors[0].lighten(0.2).hex() : colors[0].hex(),
		...
		// EDITOR WIDGET
		'editorWidget.background': colors[0].lighten(0.2).hex(),
		'editorSuggestWidget.background': colors[0].lighten(0.2).hex(),
		...
		'debugExceptionWidget.background': colors[0].lighten(0.2).hex(),

		// EDITOR MARKER
		'editorMarkerNavigation.background': colors[0].lighten(0.2).hex(),

		// PEEK VIEW
		'peekView.border': colors[8].hex() + '33',
		'peekViewEditor.background': colors[0].lighten(0.2).hex(),
		'peekViewEditor.matchHighlightBackground': colors[1].hex() + '44',
		'peekViewResult.background': colors[0].lighten(0.2).hex(),
		...
		'walkThrough.embeddedEditorBackground': colors[0].lighten(0.2).hex(),
